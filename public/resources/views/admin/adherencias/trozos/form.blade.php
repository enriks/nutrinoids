       ...
       <div class="col-md-12 col-md-offset-2">
                ...
                <tr >
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg1', '1')}}</td>
                    </div>
                </tr>
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg2', '1')}}</td>
                    </div>
                </tr>
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg3', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg4', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg5', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-center"> Menos de una al día </td>
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg6', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-center"> Menos de una al día </td>
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg7', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg8', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg9', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-center"> Tres o más por semana </td>
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg10', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg11', '1')}}</td>
                    </div>
                </tr>
                ...
                <tr>
                    ...
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg12', '1')}}</td>
                    </div>
                </tr>
                <tr>
                    ...
                    <td class="text-center"> Si </td>
                    <div class="form-group">
                        <td align="center"> {{ Form::checkbox('pg13', '1')}}</td>
                    </div>
                </tr>
