            ...
            <div class="row align-items-end">
                <div class="col col-offset-4">
                    <div class="card">
                       ...
                       <?php $__currentLoopData = $dieteticas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dietetica): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <option data-subtext="<?php echo e($dietetica->codigo); ?>" value="<?php echo e($dietetica->id); ?>"><?php echo e($dietetica->name); ?> <?php echo e($dietetica->lastname); ?></option>
