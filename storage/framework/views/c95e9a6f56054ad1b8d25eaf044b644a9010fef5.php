                ...
                <div class="col col-offset-4">
                   <div class="card">
                        <div class="card-header">
                            Cuestionario de frecuencia de consumno: bolleria y pasteleria
                        </div>
                        <div class="card-body">
                            ...
                            <option data-subtext="<?php echo e($bolleria->codigo); ?>" value="<?php echo e($bolleria->id); ?>"><?php echo e($bolleria->name); ?> <?php echo e($bolleria->lastname); ?></option>
