                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <select id="select" name="clinicos" class="selectpicker col-md-8" data-show-subtext="true" data-live-search="true">
                                <?php $__currentLoopData = $Clinicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option data-subtext="<?php echo e($clinico->codigo); ?>" value="<?php echo e($clinico->id); ?>"><?php echo e($clinico->name); ?> <?php echo e($clinico->lastname); ?></option>
