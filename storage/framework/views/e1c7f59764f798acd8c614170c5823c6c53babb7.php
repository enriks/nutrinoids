                ...
                <div class="col col-offset-4">
                    <div class="card">
                        ...
                        <select id="select" name="verduras" class="selectpicker col-md-8" data-show-subtext="true" data-live-search="true">
                            <?php $__currentLoopData = $verduras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verdura): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option data-subtext="<?php echo e($verdura->codigo); ?>" value="<?php echo e($verdura->id); ?>"><?php echo e($verdura->name); ?> <?php echo e($verdura->lastname); ?></option>
