                ...
                <div class="col col-offset-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <select id="select" name="estudios" class="selectpicker col-md-8" data-show-subtext="true" data-live-search="true">
                       ...
                       <option data-subtext="<?php echo e($estudio->codigo); ?>" value="<?php echo e($estudio->id); ?>"><?php echo e($estudio->name); ?> <?php echo e($estudio->lastname); ?></option>
