                ...
                <div class="col col-offset-4">
                    <div class="card">
                        <div class="card-header">
                            Cuestionario de frecuencia de consumno: frutas
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Seleccione sujeto:</h5>
                            <select id="select" name="frutas" class="selectpicker col-md-8" data-show-subtext="true" data-live-search="true">
                       ...
                       <option data-subtext="<?php echo e($fruta->codigo); ?>" value="<?php echo e($fruta->id); ?>"><?php echo e($fruta->name); ?> <?php echo e($fruta->lastname); ?></option>
