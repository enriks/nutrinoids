...
<html>
  <head>
    ...
    <title>Nutrinoids | Panel Control</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>UNEAT</b>nutrix</span>
        </a>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          ...
                          <p>Porqué no te apuntas a nuestras investigaciones?</p>
                        </a>
                      </li><!-- end message -->
                      <li>
                        <a href="#">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Dashboard
            <small>Estadísticas cuestionario 1</small>
          </h1>
          <ol class="breadcrumb">
